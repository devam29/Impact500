...
- Batches 04, 05, and 06 are fully attempted (150 companies). **batch_07
  ...
  rest. **batch_09 is partially attempted through PWR (27 companies);
  resume at QCOM.** Batches 08, 10, and 11 remain untouched.
- **Repo is now on GitHub, split for parallel work**: devam29 has
  batch_07 (finish the remaining 23) + batch_08; teammate has batch_09
  (resume at QCOM), 10, 11. See "Who's working on which batch" at the top
  of this file.
